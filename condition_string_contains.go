...
// StringContainsCondition is fulfilled if the context matches a substring within the context string name
type StringContainsCondition struct {
	Contains string `json:"contains"`
}

// Fulfills returns true if the request's resouce contains the given value string
func (c *StringContainsCondition) Fulfills(value interface{}, _ *Request) bool {
	...
	resourceString := delimiterString + c.Contains + delimiterString
